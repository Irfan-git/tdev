...
class Customizer_Range_Value_Control extends \WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'customizer-range-value-control-css',
						  get_template_directory_uri() . '/assets/css/customizer/range-control.css',
						  array(),
						  '2',
						  'all'
						);

		wp_enqueue_script( 'customizer-range-value-control',
							get_template_directory_uri() . '/assets/js/customizer/range-control.js',
							array( 'jquery' ),
							'1.2',
							true
						);
